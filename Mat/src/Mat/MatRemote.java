...
/**
 * The <code>MatRemote</code> class provides a Java RMI-compliant interface to the 
 * M-functions from the files:
 * <pre>
 *  H:\\Program Files\\MATLAB\\R2012a\\bin\\matrix.m
 *  H:\\Program Files\\MATLAB\\R2012a\\bin\\tensorsvd.m
 * </pre>
 * The {@link #dispose} method <b>must</b> be called on a <code>MatRemote</code> instance 
 ...
 * generate RMI server proxy objects for instances of Mat.Mat.
 */
public interface MatRemote extends Poolable
{
    /**
     * Provides the standard interface for calling the <code>matrix</code> M-function 
     ...
     */
    public Object[] matrix(int nargout, Object... rhs) throws RemoteException;
    /**
     * Provides the standard interface for calling the <code>tensorsvd</code> M-function 
     ...
     * in communication with the server.
     */
    public Object[] tensorsvd(int nargout, Object... rhs) throws RemoteException;
